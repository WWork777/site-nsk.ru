...
const WHATSAPP = "https://wa.me/79994316266";
const TELEGRAM = "https://t.me/Pavelvrl";
const TEL = "tel:+79994316266";
  ...
  return (
    ...
    >
      ...
      <div className="container px-4">
        {/* ВАЖНО: на мобилках даём вертикальный gap, на десктопе — 0 */}
        <div className="-mx-4 flex flex-wrap items-start gap-y-8 lg:gap-y-0">
          {/* Левая колонка */}
          ...
          {/* ВАЖНО: на мобилке даём верхний отступ, на десктопе убираем */}
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12 mt-8 lg:mt-0">
            <div className="rounded-lg bg-white px-8 py-10 shadow-testimonial dark:bg-[#0F1A2A] sm:px-10 sm:py-12">
              ...
              <div className="space-y-4">
                ...
                <p className="pt-2 text-center text-xs text-dark/60 dark:text-white/60">
                  Мы не собираем данные на сайте. <br />
                  Нажимая на кнопку, вы пишете нам напрямую в мессенджере, на почту или звоните.
                </p>
              </div>
            </div>
          </div>
